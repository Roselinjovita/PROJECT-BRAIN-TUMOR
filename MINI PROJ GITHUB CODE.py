...
Original file is located at
    https://colab.research.google.com/drive/17sjqrPEfnHFwuNCoCfeqYyaaiGcz1epx
"""
...
# Try using shutil to unzip the file
try:
    shutil.unpack_archive(zip_path, extracted_folder)
...
!7z x /content/archive.zip -o/content/extracted_data/
...
data_dir = '/content/extracted_data/kaggle_3m'
...
batch_size = 8  # or 8, depending on your model and data

from tensorflow.keras.preprocessing.image import ImageDataGenerator

datagen = ImageDataGenerator(rescale=1./255)
train_generator = datagen.flow_from_directory(
    '/content/extracted_data/kaggle_3m',
...
from tensorflow.keras.preprocessing.image import ImageDataGenerator
image_datagen = ImageDataGenerator(rescale=1./255)  # Normalize images
mask_datagen = ImageDataGenerator(rescale=1./255)   # Normalize masks
...
model_checkpoint = ModelCheckpoint('unet_best_model.keras', verbose=1, save_best_only=True)
